...
Scenario: Logs editor in to the site and creates content
  ...
  And I follow "Blog Post"
    And I fill in "Title" with "Blog Testing"
    And I fill in "Body" with "Yay!"
    And I press "Save"
  Then I should see "Blog Post Blog Testing has been created."
...
Scenario: Editor deletes own content
  ...
  Then I follow "Edit"
    And I press "Delete"
    And I press "Delete"
  Then I should see "Blog Post Blog Testing has been deleted."
